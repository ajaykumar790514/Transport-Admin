                    ...
                    !0 === KTUtil.hasClass(n.element, n.options.baseClass + "-on") && "on" === String(document.body.getAttribute("data-kt-drawer-" + n.name + "-")) ? (n.shown = !0) : (n.shown = !1),
                        !0 === m("activate")
                            ? (KTUtil.addClass(n.element, n.options.baseClass),
                              ...
                              t && (KTUtil.css(n.element, "height", t, !0), (n.lastHeight = t)),
                              r && KTUtil.css(n.element, "top", r),
                              o && KTUtil.css(n.element, "bottom", o),
                              a && (KTUtil.isRTL() ? KTUtil.css(n.element, "right", a) : KTUtil.css(n.element, "left", a)),
                              s && (KTUtil.isRTL() ? KTUtil.css(n.element, "left", s) : KTUtil.css(n.element, "right", s)))
                            : (KTUtil.removeClass(n.element, n.options.baseClass),
                              ...
                              a && (KTUtil.isRTL() ? KTUtil.css(n.element, "right", "") : KTUtil.css(n.element, "left", "")),
                              s && (KTUtil.isRTL() ? KTUtil.css(n.element, "left", "") : KTUtil.css(n.element, "right", "")),
                              l());
                },
                d = function () {
                    !0 === m("overlay") &&
        ...
        document.addEventListener("keydown", (e) => {
            if ("Escape" === e.key) {
                if (!(e.ctrlKey || e.altKey || e.shiftKey)) {
                    var t,
                        n = document.querySelectorAll('.drawer-on[data-kt-drawer="true"]:not([data-kt-drawer-escape="false"])');
                        ...
                        if (!0 === o) {
                            if (t > i && s) {
                                ...
                                !0 === document.body.hasAttribute(n.attributeName) &&
                                    (l(), document.body.removeAttribute(n.attributeName), document.body.removeAttribute(n.attributeName2), n.element.removeAttribute("data-kt-sticky-enabled")),
                            ...
                            !0 === document.body.hasAttribute(n.attributeName) && (l(), document.body.removeAttribute(n.attributeName), document.body.removeAttribute(n.attributeName2), n.element.removeAttribute("data-kt-sticky-enabled")),
                                !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), (n.eventTriggerState = !0));
        ...
        init: function () {
            ...
            a &&
                ...
                (null !== u &&
                    ...
                    setTimeout(function () {
                        ...
                        KTCookie.set("app_engage_prebuilts_modal_displayed", "1", { expires: e });
                    }, 3e3),
                (function () {
            ...
            a &&
                ...
                (l.addEventListener("click", function (e) {
                    ...
                    KTCookie.set("app_engage_hide", "1", { expires: t }), a.classList.add("app-engage-hide");
                }),
...
var KTAppSidebar = (function () {
    ...
    return {
        init: function () {
            ...
            (n = document.querySelector("#kt_app_sidebar_menu_dashboards_collapse")),
            ...
            null !== e) &&
                ...
                i && (l = i.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(l, i) && i.scroll({ top: KTUtil.getRelativeTopPosition(l, i), behavior: "smooth" }),
                n &&
