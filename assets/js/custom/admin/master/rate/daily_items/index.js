                ...
                deleteSelectedBtn.addEventListener("click", function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                type: "POST",
                                url: CI_ROOT + 'daily-items-master/delete_selected', // Replace with your actual endpoint URL to handle multiple deletions
        ...
        init: function () {
            ...
            if (e) {
                ...
                t = $(e).DataTable({
                    ...
                    order: [],
                    ajax: {
                        url: CI_ROOT + 'daily-items-master/get_daily_items', 
                        type: 'GET',
						data: function(d) {
