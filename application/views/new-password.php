...
<html lang="en" >
    ...
    <head>
        ...
        <link rel="canonical" href="https://preview.keenthemes.com<?=base_url();?>authentication/layouts/corporate/new-password.html"/>
...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="<?=base_url();?>reset-update-pass" action="<?=base_url();?>reset-update-pass" method="post">
    <!--begin::Heading-->
    <div class="text-center mb-10">
        ...
        <div class="text-gray-500 fw-semibold fs-6">
            ...
            <a href="<?=base_url();?>login/admin" class="link-primary fw-bold">
               Login
            </a>
        </div>
        <!--end::Link-->
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7" data-kt-menu="true" id="kt_auth_lang_menu">
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="<?=base_url();?>assets/media/flags/spain.svg" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="<?=base_url();?>assets/media/flags/germany.svg" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="<?=base_url();?>assets/media/flags/japan.svg" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="<?=base_url();?>assets/media/flags/france.svg" alt=""/>
                                </span>
        ...
        <script>
            var hostUrl = "<?=base_url();?>assets/";        </script>
                    ...
                    <!--begin::Custom Javascript(used for this page only)-->
                            <script src="<?=base_url();?>assets/js/custom/authentication/reset-password/new-password.js"></script>
