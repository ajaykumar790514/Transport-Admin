...
<div id="kt_app_header" class="app-header " 
	...
	<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
		<a href="<?=base_url('dashboard');?>">
			<img alt="Logo" src="<?php echo base_url();?>assets/media/logos/default-dark.svg" class="h-20px h-lg-30px app-sidebar-logo-default"/>
		</a>
	</div>
	<!--end::Logo-->
...
<!--begin::Menu wrapper-->
<div 
    class="app-header-menu  app-header-mobile-drawer align-items-stretch"data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end"
...
<?php $roleid = $user->user_role;?>
		...
		<?php if($allid==0){?>
            ...
            <span class="menu-link"  >
                <span  class="menu-title" >  <a  href="<?=base_url($url);?>" id="navbarDropdown<?= str_replace(' ', '', $menu->title) ?>" ><i class="<?= $menu->icon_class; ?>"></i>&nbsp;<?= $menu->title; ?></a>
		...
		<?php }else{?>
            ...
            <!--begin:Menu link-->
            <span class="menu-link"  >
                <span  class="menu-title" ><a  href="<?=base_url($url);?>" id="navbarDropdown<?= str_replace(' ', '', $menu->title) ?>" ><i class="<?= $menu->icon_class; ?>"></i>&nbsp;<?= $menu->title; ?></a></span>
                <span  class="menu-arrow d-lg-none" ></span>
            </span><!--end:Menu link-->
            <!--begin:Menu sub-->
        ...
        <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px" >
            ...
            if($submenucount ==0){
            ?>
        <div  data-kt-menu-placement="right-start"  class="menu-item menu-lg-down-accordion" ><!--begin:Menu link--><span class="menu-link"  >
			<span  class="menu-icon" ><i class="<?= $r->icon_class; ?>"><span class="path1"></span><span class="path2"></span></i></span>
		<span  class="menu-title" ><a  href="<?php echo base_url($r->url.'/'.$r->id); ?>"><?= $r->title ?></a></span>
		</span><!--end:Menu link-->
        </div>
		<?php }else{?>
			<div   data-kt-menu-placement="right-start"  class="menu-item menu-lg-down-accordion" ><!--begin:Menu link--><span class="menu-link"  ><span  class="menu-icon" ><i class="<?= $r->icon_class; ?> "><span class="path1"></span><span class="path2"></span></i></span>
		<span  class="menu-title" ><a  href="<?php echo base_url($r->url.'/'.$r->id); ?>"><?= $r->title ?></a></span>
		<span  class="menu-arrow" ></span></span><!--end:Menu link-->
        <!--begin:Menu sub-->
        ...
        <div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="/metronic8/demo1/apps/projects/settings.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" ><a href="<?php echo base_url($men->url.'/'.$men->id); ?>"><?= $men->title ?></span></a><!--end:Menu link--></div>
		<?php endforeach;?> 
        <!--end:Menu item-->
        </div>
    ...
    <div class="scroll-y mh-200px mh-lg-350px">
            ...
            <!--end::Category title-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <img src="<?php echo base_url();?>assets/media/avatars/300-6.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="<?php echo base_url();?>assets/media/avatars/300-2.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="<?php echo base_url();?>assets/media/avatars/300-9.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="<?php echo base_url();?>assets/media/avatars/300-14.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="<?php echo base_url();?>assets/media/avatars/300-11.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
            ...
            <!--end::Category title-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="<?php echo base_url();?>assets/media/svg/brand-logos/volicity-9.svg" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="<?php echo base_url();?>assets/media/svg/brand-logos/tvit.svg" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="<?php echo base_url();?>assets/media/svg/misc/infography.svg" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="<?php echo base_url();?>assets/media/svg/brand-logos/leaf.svg" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="<?php echo base_url();?>assets/media/svg/brand-logos/tower.svg" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
...
<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
    ...
    <div class="d-flex justify-content-end">
        ...
        <a href="/metronic8/demo1/utilities/search/horizontal.html" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
    </div>
    <!--end::Actions-->
</form>
<!--end::Preferences-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
	<!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo base_url();?>assets/media/misc/menu-header-bg.jpg')">
        <!--begin::Title-->                                   
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
            ...
            <div class="d-flex flex-column px-9">
                ...
                <div class="text-center px-4">
                    <img class="mw-100 mh-200px" alt="image" src="<?php echo base_url();?>assets/media/illustrations/sketchy-1/1.png"/>
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
                ...
                <div class="row g-2">
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/amazon.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/angular-icon-1.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/atica.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/beats-electronics.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/codeigniter.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/bootstrap-4.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/google-tag-manager.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/disqus.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/dribbble-icon-1.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/google-play-store.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/google-podcasts.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/figma-1.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/github.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/gitlab.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/instagram-2-1.svg" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo base_url();?>assets/media/svg/brand-logos/pinterest-p.svg" class="w-25px h-25px mb-2" alt=""/>
...
<!--end::Menu-->
        ...
        <a href="#" class="menu-link px-5">
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="<?php echo base_url();?>assets/media/flags/united-states.svg" alt=""/>
                </span>
            </span>
        </a>
    ...
    <?php }else{?>
		<a href="<?=base_url()?>shop-logout" class="menu-link px-5">
            Sign Out
        </a>
    <?php }?>
