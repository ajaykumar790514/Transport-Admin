											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10 mt-5	 fv-row">
														...
														<!--begin::Input-->
																	<input type="text" name="product_sku" class="form-control mb-2" placeholder="Product SKU" value="" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
														<!--begin::Input group-->
														...
														<!--begin::Input-->
																	<input type="text" name="keywords" class="form-control mb-2" placeholder="Product Keywords" value="" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
												</div>
												...
												<div class="mb-10 fv-row">
													...
													<div class="input-group mb-2">
														<div class="row">
															<div class="col-lg-4">
														<!--begin::Rupee Input-->
														<input type="number" name="price" class="w-lg-300px form-control" placeholder="Product price" value="" />
															   <!--end::Rupee Input-->
															</div>
															<div class="col-lg-8">
															<!--begin::Unit Selector-->
												...
												<!--end::Input group-->
													...
													<div class="input-group mb-2">
														<div class="row">
															<div class="col-lg-4">
														<!--begin::Rupee Input-->
														<input type="number" name="qty" class="w-lg-300px form-control" placeholder="Product quantity" value="" />
															   <!--end::Rupee Input-->
															</div>
															<div class="col-lg-8">
															<!--begin::Unit Selector-->
