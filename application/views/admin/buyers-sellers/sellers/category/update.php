	...
	<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
													...
													<!--begin::Image input-->
														...
														<?php if(!empty($value->thumbnail)){?>
															...
															.image-input-placeholder {
																background-image: url('<?=IMGS_URL.$value->icon;?>');
															}
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													<!--begin::Select2-->
													<select class="form-select mb-2" name="status"  id="kt_ecommerce_add_category_status_select">
														<option></option>
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10 fv-row col-lg-4">
														...
														<option value="<?php echo $parent->id; ?>" <?php if($parent->id == $value->parent){echo "selected";}else if($parent->id == $value->subcat_is_parent){echo "selected";} ?>>
													...
													<div class="mb-10 fv-row col-lg-4">
														...
														<!--begin::Input-->
																	<input type="text" name="name" class="form-control form-control-solid mb-2" placeholder="Category name" value="<?php echo $value->name;?>"/>
														<!--end::Input-->
													...
													<!--end::Input group-->
														...
														<!--begin::Input-->
																	<input type="text" name="seq" class="form-control form-control-solid mb-2" placeholder="Seq"  value="<?php echo $value->seq; ?>"/>
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="mb-10 fv-row col-lg-12">
														<!--begin::Label-->
														<label class="required form-label">Category Url: <span class="text-danger">( Enter only category name proper url type )</span></label>
														<!--end::Label-->
											
														<!--begin::Input-->
																	<input type="text" class="form-control form-control-solid mb-2" placeholder="Url"  name="url" value="<?php echo @$value->url; ?>" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
