				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						<!--begin::Search-->
							...
							<i class="ki-duotone ki-magnifier fs-3 position-absolute ms-5"><span class="path1"></span><span class="path2"></span></i>                <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Users" />
							</div>
						<!--end::Search-->
					</div>
			<!--begin::Card title-->
			  ...
			  <!--end::Card header-->
				...
				<div class="card-body pt-0">
					...
					<th class="text-start min-w-70px"><span class="fw-bold text-dark">Username</span></th>
					<th class="text-start min-w-70px"><span class="fw-bold text-dark">Mobile</span></th>
					<th class="text-start min-w-70px"><span class="fw-bold text-dark">Email</span></th>
