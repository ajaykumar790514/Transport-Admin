...
<div class="row">
        <div class="col-lg-6 col-sm-12 col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-solid" name="userName" value="<?= $value->username; ?>">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6">
            <div class="form-group">
                <label class="form-check-label">Full Name:</label>
                <input type="text" class="form-control form-control-solid" name="fullName" value="<?= $value->name; ?>">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-3">
            <div class="form-group">
                <label class="form-check-label">Email:</label>
                <input type="email" class="form-control form-control-solid" name="email" value="<?= $value->email; ?>">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-3">
            <div class="form-group">
                <label class="form-check-label">Mobile:</label>
                <input type="number" class="form-control form-control-solid" name="contact" value="<?= $value->mobile; ?>">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-3">
            <div class="form-group">
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 mt-3">
            <div class="form-group">
                ...
                <?php foreach ($user_roles as $roles) { ?>
					<option value="<?php echo $roles->id; ?>" <?php if($roles->id == $value->user_role){echo "selected";} ?>>
                    <?php echo $roles->name; ?>
                </option>
                <?php } ?>
                </select>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <img src="<?php echo IMGS_URL.$value->photo;?>" alt="<?php echo $value->name; ?>" height="50">
            <?php } ?> 
            </div>
        </div>
        </div>
