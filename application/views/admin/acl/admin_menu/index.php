				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						<!--begin::Search-->
							...
							<i class="ki-duotone ki-magnifier fs-3 position-absolute ms-5"><span class="path1"></span><span class="path2"></span></i>                <input type="text" data-kt-menu-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Admin Menus" />
							</div>
						<!--end::Search-->
					</div>
			<!--begin::Card title-->
				...
				<div class="card-toolbar">
					...
					<button type="button" class="btn btn-danger" data-kt-menu-table-select="delete_selected">
			  ...
			  <!--end::Card header-->
				...
				<div class="card-body pt-0">
					...
					<input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_menus_table .form-check-input" value="1" />
					</div>
					</th>
					<th class="text-start min-w-40px"><span class="fw-bold text-dark">S.No.</span></th>
					<th class="text-start min-w-50px"><span class="fw-bold text-dark">TITLE</span></th>
					<th class="text-start min-w-50px"><span class="fw-bold text-dark">INDEXING</span></th>
