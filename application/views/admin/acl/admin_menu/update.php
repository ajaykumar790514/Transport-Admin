    ...
    <div class="row">
          <div class="col-lg-4">
            <div class="form-group">
                ...
                <?php foreach ($parent_menus as $parent) { ?>
                    <option value="<?= $parent->id; ?>" <?php if($parent->id == @$main_parent->id){echo "selected";}?>>
        ...
        <div class="col-lg-4 mt-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-solid" name="title" value="<?= $value->title; ?>">
            </div>
        </div>
        <div class="col-lg-5 mt-3">
            <div class="form-group">
                <label class="form-check-label">Icon class:</label>
                <input type="text" class="form-control form-control-solid" name="icon_class" value="<?= $value->icon_class; ?>">
            </div>
        </div>
        ...
        <div class="col-lg-5 mt-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-solid" name="url" value="<?= $value->url; ?>">
            </div>
        </div>
        <div class="col-lg-2 mt-3">
            <div class="form-group">
                <label class="form-check-label">Indexing:</label>
                <input type="number" class="form-control form-control-solid" name="indexing" value="<?= $value->indexing; ?>">
            </div>
        </div>
        </div>
