    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                ...
                <select class="form-control" name="what_you_provide">
                    ...
                    <option value="Transport Contactor">Transport Contactor</option>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                ...
                <input type="number" class="form-control form-control" name="mobile_number" placeholder="Enter Mobile Number">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2">Email Address:</label>
                <input type="email" class="form-control form-control" name="email" placeholder="Enter Email Address">
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12 mt-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control form-control" name="minimum_load" placeholder="Enter Minimum Load">
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                ...
                <select name="city" id="city" class="select2 form-select form-control"></select>
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2 required">Building Number:</label>
                <input type="text" class="form-control form-control" name="building_number" placeholder="Enter Building Number">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2 required">Area / Street:</label>
                <input type="text" class="form-control form-control" name="area_street" placeholder="Enter Area / Street">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2">Landmark:</label>
                <input type="text" class="form-control form-control" name="landmark" placeholder="Enter Landmark">
            </div>
        </div>
        <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2">Pincode:</label>
                <input type="number" class="form-control form-control" name="pincode" placeholder="Enter Pincode">
            </div>
        </div>
    </div>
