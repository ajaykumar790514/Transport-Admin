...
<div class="row">
        <div class="col-lg-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control" name="title" value="<?=$value->title;?>">
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12 mt-3">
            <div class="form-group">
                <label class="form-check-label required">Description:</label>
                <textarea class="form-control form-control" name="description"><?=$value->description;?></textarea>
            </div>
        </div>
        </div>
</div>
