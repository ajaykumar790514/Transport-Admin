...
<div class="row">
		...
		<div class="col-lg-6 col-sm-12 col-md-6  mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2 required">Logo :</label>
		...
		<div class="col-lg-6 col-sm-12 col-md-6 mt-4">
            <div class="form-group">
                ...
                <input type="number" class="form-control"  name="seq" placeholder="Enter Seq">
            </div>
        </div>
		<div class="col-lg-6 col-sm-12 col-md-6  mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2 required">Price :</label>
				<input type="number" class="form-control form-control" name="price" placeholder="Enter Price">
            </div>
        </div>
		<div class="col-lg-6 col-sm-12 col-md-6  mt-4">
            <div class="form-group">
                <label class="form-check-label mb-2 required">Validity ( in days ):</label>
				<input type="number" class="form-control form-control" name="validity" placeholder="Enter Validity">
            </div>
        </div>
		<div class="col-lg-12 col-sm-12 col-md-12 mt-4">
		<div class="form-group">
			<label class="form-check-label mb-2">Description:</label>
			<div id="description" style="height: 180px" class="form-control form-control"></div>
			<textarea name="description"   class="form-control form-control d-none"></textarea>
		</div>
	</div>
