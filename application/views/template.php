...
<html lang="en" >
    ...
    <head>
        ...
        <link rel="canonical" href="https://preview.keenthemes.com/metronic8/demo1/layouts/dark-header.html"/>
...
<div 
    ...
    style="background-image:url('<?php echo base_url();?>assets/media/misc/layout/customizer-header-bg.jpg')">
...
<!--end::Card header-->
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content"
				...
				<!--begin::Form-->
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="/metronic8/demo1/index.php">
	...
	<div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="<?php echo base_url();?>assets/media/preview/demos/demo1/light-ltr.png" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					<!--begin::Image--> 
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="<?php echo base_url();?>assets/media/preview/demos/demo1/dark-ltr.png" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
...
<div class="form-group">
	...
	<div class="mb-6">
		...
		<a href="/metronic8/demo1/layout-builder.html" class="fw-semibold text-primary">More layout options</a>
	</div>
	<!--end::Heading-->                  
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				<!--begin::Option-->
				<label class="form-check-image form-check-success  disabled " disabled  data-bs-toggle="tooltip" title="This page's tayout can not be changed" >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="<?php echo base_url();?>assets/media/misc/layout/dark-sidebar.png" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success  disabled " disabled  data-bs-toggle="tooltip" title="This page's tayout can not be changed" >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="<?php echo base_url();?>assets/media/misc/layout/light-sidebar.png" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				<!--begin::Option-->
				<label class="form-check-image form-check-success active disabled active" disabled  data-bs-toggle="tooltip" title="This page's tayout can not be changed" >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="<?php echo base_url();?>assets/media/misc/layout/dark-header.png" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success  disabled " disabled  data-bs-toggle="tooltip" title="This page's tayout can not be changed" >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="<?php echo base_url();?>assets/media/misc/layout/light-header.png" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
        ...
        <div class="pe-3 mb-5">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
                    <img src="<?php echo base_url();?>assets/media/avatars/300-14.jpg" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
        ...
        <div class="overflow-auto pb-5">
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">  
                ...
                <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                    ...
                    <div class="symbol symbol-circle symbol-25px">
                        <img src="<?php echo base_url();?>assets/media/avatars/300-2.jpg" alt="img"/>
                    </div>
                    <!--end::User-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">  
                ...
                <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                    <!--begin::User-->
                    <div class="symbol symbol-circle symbol-25px">
                        <img src="<?php echo base_url();?>assets/media/avatars/300-20.jpg" alt="img"/>
                    </div>
                    <!--end::User-->                               
        ...
        <div class="overflow-auto pe-3">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                    <img src="<?php echo base_url();?>assets/media/avatars/300-1.jpg" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="mb-5 pe-3">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
                    <img src="<?php echo base_url();?>assets/media/avatars/300-23.jpg" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/metronic8/demo1/apps/projects/project.html" class="w-30px me-3" src="<?php echo base_url();?>assets/media/svg/files/doc.svg"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/metronic8/demo1/apps/projects/project.html" class="w-30px me-3" src="<?php echo base_url();?>assets/media/svg/files/css.svg"/>
                    <!--end::Icon--> 
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                ...
                <div class="overlay me-10">  
                    ...
                    <div class="overlay-wrapper">
                        <img alt="img" class="rounded w-150px" src="<?php echo base_url();?>assets/media/stock/600x400/img-29.jpg"/>  
                    </div>
                    <!--end::Image-->
                ...
                <div class="overlay me-10">   
                    <!--begin::Image-->                                     
                    <div class="overlay-wrapper">
                        <img alt="img" class="rounded w-150px" src="<?php echo base_url();?>assets/media/stock/600x400/img-31.jpg"/> 
                    </div>
                    <!--end::Image-->
                ...
                <div class="overlay">   
                    <!--begin::Image-->                                     
                    <div class="overlay-wrapper">
                        <img alt="img" class="rounded w-150px" src="<?php echo base_url();?>assets/media/stock/600x400/img-40.jpg"/>
                    </div>
                    <!--end::Image-->
        ...
        <div class="pe-3 mb-5">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
                    <img src="<?php echo base_url();?>assets/media/avatars/300-4.jpg" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
    ...
    <div class="d-flex justify-content-start mb-10 " >
        ...
        <div class="d-flex flex-column align-items-start">
            ...
            <div class="d-flex align-items-center mb-2">
                                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="<?php echo base_url();?>assets/media/avatars/300-25.jpg"/></div><!--end::Avatar-->
                    <!--begin::Details-->
                    <div class="ms-3">
    ...
    <div class="d-flex justify-content-end mb-10 " >
        ...
        <div class="d-flex flex-column align-items-end">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="<?php echo base_url();?>assets/media/avatars/300-1.jpg"/></div><!--end::Avatar-->                 
            </div>
            <!--end::User-->
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="/metronic8/demo1/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-1.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="/metronic8/demo1/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-3.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="/metronic8/demo1/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-8.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="/metronic8/demo1/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-26.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="/metronic8/demo1/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-21.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="/metronic8/demo1/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-34.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo base_url();?>assets/media/stock/600x400/img-27.jpg" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
...
<div data-kt-stepper-element="content">
    <div class="w-100 text-center">
        ...
        <div class="text-center px-4 py-15">       
            <img src="<?php echo base_url();?>assets/media/illustrations/sketchy-1/9.png" alt="" class="mw-100 mh-300px"/>
        </div>
        <!--end::Illustration-->
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="<?php echo base_url('');?>assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3"/>
...
<!--end::Modal - Invite Friend-->            <!--end::Modals-->
        ...
        <!--begin::Javascript-->
        <script>
            var hostUrl = "<?php echo base_url();?>assets/";        </script>
                    ...
                    <!--begin::Custom Javascript(used for this page only)-->
							...
							<!-- <script src="<?=base_url()?>assets/js/sweetalert2.all.js" type="text/javascript"></script> -->
							<script src="<?=base_url()?>assets/js/sweet-alerts.js" type="text/javascript"></script>
							<script  src="<?=base_url()?>assets/js/jquery.validate.js"></script>
							<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
							<?php
							if (isset($scripts) && is_array($scripts)) {
								foreach ($scripts as $script) {
									echo "<script src='" . base_url('assets/js/custom/' . $script . '.js') . "'></script>";
								}
							}else
							if(isset($script)) {
								$item = explode( ',', $script);
								foreach($item as $list){
									echo "<script src='".base_url('assets/js/custom/'.$list.'.js')."'></script>";
								}
							} 
							?>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                ...
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" class="close" data-bs-dismiss="modal" aria-label="Close"  data-kt-users-modal-action="close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>                </div>
                <!--end::Close-->
            </div>
            <!--end::Modal header-->
...
<!--end::Modal - Add task--> 
<!--begin::Modal - Add task-->
<div class="modal fade" id="showModal-xl" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                ...
                <!--begin::Close-->
                <div class="btn btn-icon float-right btn-sm btn-active-icon-primary" data-kt-users-modal-action="close"  class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>                </div>
                <!--end::Close-->
            </div>
            <!--end::Modal header-->
...
$(document).on("submit", '.ajaxsubmit', function(event) {
    ...
    if ($this.hasClass("validate-form")) {
        form_valid = $this.valid();
    }

    if (form_valid) {
        var $submitButton = $this.find('button[type="submit"]');
        var originalText = $submitButton.html();
        $submitButton.html('<i class="spinner-border spinner-border-sm"></i> Please wait...').prop('disabled', true);
        setTimeout(function() {
            $.ajax({
                url: $this.attr("action"),
                type: $this.attr("method"),
                ...
                error: function() {
                    alert_toastr('error', 'An error occurred. Please try again.');
                },
                complete: function() {
